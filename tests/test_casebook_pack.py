"""Regression checks for the signal-sim-market-scope casebook."""
...
from casebook.harness import assert_expected, signal_sim_market_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_sim_market_scope_summary(), assert_expected())
